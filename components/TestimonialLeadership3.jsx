...
export default function TestimonialLeadership3() {
    return (
          ...
          <div className="relative lg:flex lg:items-center">
            <div className="hidden lg:block lg:flex-shrink-0">
              <img
                ...
                src="src/profile-maddie.jpg?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                alt=""
              />
            </div>
                ...
                <footer className="mt-8">
                  <div className="flex">
                    ...
                    <div className="ml-4 lg:ml-0">
                      <div className="text-base font-medium text-gray-900">Madeleine van Dam</div>
                      <div className="text-base font-medium text-indigo-600">Product Designer, Ofload, Australia</div>
                    </div>
                  </div>
                </footer>
              </blockquote>
