    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          {people.map((person) => (
            <li key={person.name}>
              <a href={person.xUrl} target="_blank" data-event-category="purchase" data-event-action="click_buy_elsewhere" data-event-label="cta_book_elsewhere"><img className="aspect-[3/2] w-full rounded-2xl object-cover" src={person.imageUrl} alt="" /></a>
