...
export default function TestimonialLargeAvatar3() {
    return (
                  ...
                  <div className="flex">
                    <div className="flex-shrink-0 lg:hidden">
                      <img
                        ...
                        src="src/profile-kumari.jpg?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                        alt=""
                      />
                    </div>
                    <div className="ml-4 lg:ml-0">
                      <div className="text-base font-medium text-gray-900">Kumari Pacheco</div>
                      <div className="text-base font-medium text-indigo-600">Content Designer, A Book Apart</div>
                    </div>
                  </div>
                </footer>
              </blockquote>
