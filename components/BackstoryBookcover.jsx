    ...
    <section className="py-16 bg-white overflow-hidden lg:py-24">
      <div className="text-center">
        <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
          <span id="bookcover" className="block xl:inline">Book cover>{' '}
        ...
        { /* <div className="mt-5 px-4 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
          <div className="rounded-md shadow">
            <a
              ...
              data-event-category="subscribe"
              data-event-action="click_subscribe_podcast"
              data-event-label="cta_backstory_masthead"
            >
              Listen to podcast
            </a>
          </div>
