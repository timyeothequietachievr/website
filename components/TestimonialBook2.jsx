...
export default function TestimonialBook2() {
    return (
          ...
          <div className="relative lg:flex lg:items-center">
            <div className="hidden lg:block lg:flex-shrink-0">
              <img
                ...
                src="src/profile-amyzhu.jpg?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                alt=""
              />
            </div>
  
            <div className="relative lg:ml-10">
            <h2 className="text-3xl font-extrabold tracking-tight text-gray-900">Reviews from quiet achievers</h2> <br />
              <svg
