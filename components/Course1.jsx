          ...
          <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
            <div>
              <div className="mt-6">
                ...
                4 weeks course, 3-4hrs time commitment per week. <strong>Topics:</strong>Meetings, Pubilc Speaking, Introducing yourself with confidence, Being more visible in your org, Networking, Small talk, Handling difficult conversations<br /><strong>First call:</strong>Wed (US, Canada) & Thu (rest of world) - live presentation of week's lessons. During the week, you prctice the lessons an share your work. <strong>Second call:</strong>Mon (US, Canada) & Tue (rese of world) - Ask Me Anything to discuss how your practice went.<br /><strong>Session times:</strong><br />SYD 10am/5pm<br />UK 1am/8am<br />EST 8pm/3am<br />PST 5am/12am<br />
