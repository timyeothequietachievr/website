    ...
    return (
      <div className="relative bg-indigo-300">
        ...
        <h2 class="text-white font-semibold text-indigo-600 tracking-wide">introducing</h2>
          ...
          Tim Yeo has spent his career in rooms full of strong opinions and loud voices. A designer and leader in startups for 16 years, he's spoken at international conferences and has coached nearly a hundred introverts. <a href="/about"> Learn more about Tim</a> 
          </p>
        </div>
      </div>
    )
