...
export default function TestimonialCoaching2() {
    return (
                ...
                <footer className="mt-8">
                  <div className="flex">
                    ...
                    <div className="ml-4 lg:ml-0">
                      <div className="text-base font-medium text-gray-900">Erin Yeh</div>
                      <div className="text-base font-medium text-indigo-600">UX/UI Design, Australia</div>
                    </div>
                  </div>
                </footer>
              </blockquote>
